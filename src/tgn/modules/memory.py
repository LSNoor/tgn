...
class Memory(nn.Module):
    ...
    def __init_memory__(self):
        ...
        self.memory = nn.Parameter(torch.zeros((self.n_nodes, self.memory_dimension), device=self.device),
                                   requires_grad=False)
        self.last_update = nn.Parameter(torch.zeros(self.n_nodes, device=self.device),
                                        requires_grad=False)
