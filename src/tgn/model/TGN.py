...
class TGN(torch.nn.Module):
    ...
    def __init__(
        ...
        message_function: Literal["mlp", "identity"] = "mlp",
        mean_time_shift_src=0,
        std_time_shift_src=1,
        mean_time_shift_dst=0,
        std_time_shift_dst=1,
        n_neighbors=None,
        aggregator_type: Literal["last", "mean"] = "last",
        memory_updater_type: Literal["gru", "rnn"] = "gru",
        ...
        self.use_destination_embedding_in_message: bool = (
            use_destination_embedding_in_message
        )
        self.use_source_embedding_in_message: bool = use_source_embedding_in_message
        self.dyrep: bool = dyrep
    ...
    def compute_temporal_embeddings(
        ...
        layer
        :return: Temporal embeddings for sources, destinations and negatives nodes
        """
